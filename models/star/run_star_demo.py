...
from models.star.head_first_rules import analyze_head_first
from models.star.head_first_classifier import classify_head_first
...
from models.star.visualize import (
    plot_core_claim_boundary,
    plot_star_requirement_status,
    plot_star_summary,
    plot_star_radar,
)
...
DEMO_ANSWER_COUNT = 3
BATCH_SIZE = 1000
TRAIN_SCORE_PATH = PROJECT_ROOT / "data" / "processed" / "star_train_scores.csv"
...
core_claim_path = plot_core_claim_boundary(head_binary, FIGURE_DIR / "star_demo_core_claim_boundary.png")
star_radar_path = plot_star_radar(star, FIGURE_DIR / "star_demo_star_radar.png")
summary_path = plot_star_summary(head_binary, star, {}, FIGURE_DIR / "star_demo_summary.png")
status_path = plot_star_requirement_status(
    head_binary,
    star,
    {},
    FIGURE_DIR / "star_demo_requirement_status.png",
)
